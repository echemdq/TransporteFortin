...
INSERT INTO `estadoscheques` VALUES (1,'En cartera'),(2,'Depositado'),(3,'Entregado a terceros'),(4,'Rechazados'),(10,'Propios Emitidos'),(11,'Propios Anulados'),(12,'Propios entregados a terceros'),(13,'Propios depositados');
...
--
-- Table structure for table `movcheques`
--
...
CREATE TABLE `movcheques` (
  `idmovcheques` int(11) NOT NULL AUTO_INCREMENT,
  `idbancos` int(11) NOT NULL,
  ...
  PRIMARY KEY (`idmovcheques`),
  KEY `fkidestadoscheques_idx` (`idestadoscheques`),
  CONSTRAINT `fkidestadoscheques` FOREIGN KEY (`idestadoscheques`) REFERENCES `estadoscheques` (`idestadoscheques`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-03-29 22:15:22
