...
INSERT INTO `accesos` VALUES (1,'ABM FLETEROS'),(2,'ABM CLIENTES'),(3,'ABM EMPRESAS'),(4,'ABM PROVEEDORES'),(5,'EMITIR ORDEN DE CARGA'),(6,'CONSULTAR ORDEN DE CARGA'),(7,'ABM USUARIOS'),(8,'EMITIR ORDEN DE COMBUSTIBLE'),(9,'ABM BANCOS'),(10,'CUENTAS PROPIAS'),(11,'CTA CTE CLIENTES'),(12,'RECIBO CLIENTES'),(13,'INFORME GRAL CLIENTES'),(14,'SALDO EMPRESAS'),(15,'INFORME GRAL EMPRESAS'),(16,'CTA CTE FLETEROS'),(17,'RECIBO FLETEROS'),(18,'INFORME GRAL FLETEROS'),(19,'CTA CTE PROVEEDORES'),(20,'ABM CONCEPTOS'),(21,'ABM CONCEPTOS CAJA'),(22,'ABM ESTADOS CHEQUES');
...
INSERT INTO `accesosusuario` VALUES (2,3,3),(3,3,2),(4,7,2),(5,8,2),(26,9,1),(27,9,2),(28,9,3),(29,9,4),(30,9,5),(31,9,6),(32,9,7),(33,9,8),(34,9,9),(35,9,10),(36,9,11),(37,9,12),(38,9,13),(39,9,15),(40,9,16),(41,9,14),(42,9,18),(43,9,20),(44,9,19),(45,9,22),(46,9,17),(47,9,21);
...
INSERT INTO `contadores` VALUES (2,'ocarga',22,13),(4,'ocarga',17,7),(5,'ocombustible',3,7),(6,'ocumbustible',0,13),(7,'recibo clientes',1,7),(8,'recibo fleteros',0,13),(9,'opago fleteros',0,13),(10,'opago proveedores',0,13);
...
CREATE TABLE `recibos` (
  ...
  `idusuarios` int(11) NOT NULL,
  `idsucursales` int(11) NOT NULL,
  `tipo` varchar(1) NOT NULL COMMENT '0 recibo\n1 opago',
  PRIMARY KEY (`idrecibos`),
  KEY `fkidflet_idx` (`idfleteros`),
  KEY `fksuc_idx` (`idsucursales`),
  KEY `fkusu_idx` (`idusuarios`),
  CONSTRAINT `fksuc` FOREIGN KEY (`idsucursales`) REFERENCES `sucursales` (`idsucursales`) ON UPDATE CASCADE,
  CONSTRAINT `fkusu` FOREIGN KEY (`idusuarios`) REFERENCES `usuarios` (`idusuarios`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `recibos` VALUES (1,'2017-04-06 00:00:00',18,1,10.00,'',1,0,0,7,2,9,2,'0');
...
-- Dump completed on 2017-04-06 21:06:14
