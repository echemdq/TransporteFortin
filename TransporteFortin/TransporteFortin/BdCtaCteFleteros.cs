...
namespace TransporteFortin
{
    public class BdCtaCteFleteros : IDAO<CtaCteFleteros>
    {
        ...
        {
            DataTable dt = oacceso.leerDatos("select f.fecha, c.descripcion as concepto, f.descripcion as descripcion, f.ptoventa, o.nrocarga as nrocarga, debe, haber from ctactefleteros f inner join conceptos c on f.idconceptos = c.codigo inner join ordenescarga o on f.idordenescarga = o.idordenescarga where f.idfleteros = '" + dato + "'");
