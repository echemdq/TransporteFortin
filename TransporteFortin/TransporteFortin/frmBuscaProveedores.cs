...
{
    public partial class frmBuscaProveedores : Form
    {
        public Proveedores u = null;
        ...
        private void frmBuscaProveedores_Load(object sender, EventArgs e)
        {
            dataGridView1.ColumnCount = 14;
            dataGridView1.Columns[0].Name = "idproveedores";
            ...
            dataGridView1.Columns[13].Name = "Valor";
        ...
        private void btnTraer_Click(object sender, EventArgs e)
        {
            if (txtProveedor.Text != "")
            {
                ...
                string d1 = "";
                string d2 = "";
                string d3 = txtProveedor.Text.Trim();
                int cant = 1;
                ...
                List<Proveedores> lista = controlp.BuscarEspecial(d2);
                int i = 0;
                foreach (Proveedores aux in lista)
                {
                    i++;
                }
                int x = 0;
                if (i > 0)
                {
                    ...
                    foreach (Proveedores aux in lista)
                    {
                        dataGridView1.Rows[x].Cells[0].Value = aux.Idproveedores;
                        dataGridView1.Rows[x].Cells[1].Value = aux.Proveedor;
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            decimal valor = Convert.ToDecimal(dataGridView1[13, filaseleccionada].Value);
            u = new Proveedores(idcliente, cliente, direccion, localidad, cp, telefono, celular, fax, mail, contacto, cuit, tipoiv, comentario,valor);
            this.Close();
        }
    }
}
