...
namespace TransporteFortin
{
    public partial class frmCheques : Form
    {
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtorigen.Text = dataGridView1[2, filaseleccionada].Value.ToString();
            txtdestino.Text = dataGridView1[3, filaseleccionada].Value.ToString();
            txtEstado.Text = dataGridView1[4, filaseleccionada].Value.ToString();
            txtnro.Text = dataGridView1[5, filaseleccionada].Value.ToString();
            txtimporte.Text = dataGridView1[6, filaseleccionada].Value.ToString();
